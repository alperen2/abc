...
{
    /**
     * @Route("/product", name="get_product")
     */
    public function index(ProductRepository $product)
    {
        $a = $product->findAll();
        return $this->json($a, Response::HTTP_ACCEPTED);
    }

    /**
     * @Route("/product", name="add_product", methods={"POST"})
     */
    public function add(EntityManagerInterface $entityManager, Request $request, ValidatorInterface $validator)
    {
     ...
     */
    public function update($id, EntityManagerInterface $entityManager, Request $request, ValidatorInterface $validator)
    {
     ...
     */
    public function delete($id, EntityManagerInterface $entityManager, Request $request, ValidatorInterface $validator)
    {
